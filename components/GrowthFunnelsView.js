  ...
  return (
    <main className="funnel-page">
      ...
      <style jsx global>{`
        ...
        @media(max-width:620px){.new-brand-build-status{padding:16px 12px}.build-status-head{display:grid}.build-status-legend{gap:9px}.build-status-grid{grid-template-columns:1fr 1fr}.build-status-card{min-height:70px;padding:10px}.build-status-card>strong{font-size:11px}.new-brand-live{padding:18px 10px}.live-signal-block>header{display:grid}.live-signal-block>header>small{text-align:left}.live-signal-unit article{width:138px}.live-signal-arrow{width:48px}.live-signal-kpis>div{padding:9px 12px}}
