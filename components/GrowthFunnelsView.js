...
const NEW_BRAND_BUILD_STATUS = [
  ...
  { label: "Anúncios", status: "in-progress", statusLabel: "Em produção" },
  { label: "Landing page", status: "in-progress", statusLabel: "Em produção" },
  ...
  return (
    <main className="funnel-page">
      ...
      <style jsx global>{`
        ...
        @media(max-width:620px){.new-brand-build-status{padding:16px 12px}.build-status-head{display:grid}.build-status-legend{gap:9px}.build-status-grid{grid-template-columns:1fr 1fr}.build-status-card{min-height:70px;padding:10px}.build-status-card>strong{font-size:11px}}
