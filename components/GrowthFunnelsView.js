    ...
    <section className="new-brand-funnel" style={{ "--new-brand": "#F6B84B" }}>
      <header className="new-brand-head">
        <div>
          ...
          <p>Funil visual e mensurável. Cada faixa afunila a jornada e já possui um evento idempotente para receber dados da LP, n8n, Bitrix, checkout e plataforma da aula.</p>
        </div>
          ...
          return <div className="new-funnel-unit" key={stage.key}>
            ...
            >
              <div className="new-funnel-stage-main">
                ...
                <div><small>Etapa {index + 1}</small><h3>{stage.label}</h3><p>{stage.signal}</p></div>
              </div>
              <div className="new-funnel-value"><strong>{fmt(stage.value)}</strong><span>{unavailable ? "fonte não conectada" : "registros no período"}</span></div>
              <div className="new-funnel-source">
                <span>{stage.sourceLabel}</span>
                <code>{stage.eventName}</code>
              </div>
            </article>
          </div>;
        })}
      ...
      <footer className="new-brand-foot">
        ...
        <p>Arquitetura: fontes → n8n → receptor idempotente → dashboard. Bitrix continua como CRM comercial.</p>
      </footer>
    </section>
  );
}
  ...
  return (
    <main className="funnel-page">
      ...
      <style jsx global>{`
        ...
        .new-brand-funnel{border:1px solid rgba(246,184,75,.22);border-radius:22px;overflow:hidden;background:linear-gradient(145deg,rgba(246,184,75,.075),rgba(12,15,24,.96) 38%);box-shadow:0 24px 70px rgba(0,0,0,.22)}.new-brand-head{padding:30px 32px 22px;display:flex;align-items:flex-start;justify-content:space-between;gap:24px;border-bottom:1px solid rgba(255,255,255,.07)}.new-brand-head h2{margin:8px 0 8px;font-size:34px;line-height:1;letter-spacing:-.045em}.new-brand-head h2 em{font-style:normal;color:var(--new-brand)}.new-brand-head p{margin:0;max-width:780px;color:#8E96A9;font-size:13px;line-height:1.55}.new-brand-state{flex:0 0 auto;padding:8px 11px;border-radius:999px;border:1px solid rgba(246,184,75,.28);background:rgba(246,184,75,.08);color:#F6C66F;font:700 9px ui-monospace;text-transform:uppercase;letter-spacing:.08em}.new-brand-state.connected{border-color:rgba(71,215,160,.28);background:rgba(71,215,160,.08);color:#74E4B8}.new-brand-state.partial{border-color:rgba(90,140,255,.3);background:rgba(90,140,255,.09);color:#8FB0FF}.new-brand-stats{display:grid;grid-template-columns:repeat(3,1fr);border-bottom:1px solid rgba(255,255,255,.07)}.new-brand-stats>div{display:grid;gap:5px;padding:18px 24px;border-right:1px solid rgba(255,255,255,.07)}.new-brand-stats>div:last-child{border-right:0}.new-brand-stats span{color:#747D91;font:700 9px ui-monospace;text-transform:uppercase;letter-spacing:.08em}.new-brand-stats strong{font-size:24px;letter-spacing:-.035em}.new-brand-funnel-body{padding:30px 22px 36px;background:radial-gradient(circle at 50% 0,rgba(246,184,75,.08),transparent 48%),rgba(4,6,12,.32)}.new-funnel-unit{display:grid;justify-items:center}.new-funnel-transition{height:38px;display:grid;grid-template-columns:auto auto auto;place-content:center;align-items:center;gap:7px;color:#9AA2B5;font:700 8px ui-monospace;text-transform:uppercase;letter-spacing:.06em}.new-funnel-transition i{font-style:normal;color:#F6B84B;font-size:15px;line-height:1}.new-funnel-transition b{color:#F6C66F;font-size:10px}.new-funnel-transition.unavailable{color:#555E72}.new-funnel-transition.unavailable i,.new-funnel-transition.unavailable b{color:#555E72}.new-funnel-stage{width:var(--stage-width);min-height:96px;display:grid;grid-template-columns:minmax(250px,1.35fr) 115px minmax(205px,.9fr);align-items:center;gap:18px;padding:15px 42px;border:1px solid rgba(246,184,75,.24);background:linear-gradient(90deg,rgba(246,184,75,.16),rgba(246,184,75,.075) 48%,rgba(10,13,21,.95));clip-path:polygon(1.7% 0,98.3% 0,97% 100%,3% 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.045);position:relative}.new-funnel-stage-main{min-width:0;display:flex;align-items:center;gap:15px}.new-funnel-number{flex:0 0 auto;display:grid;place-items:center;width:39px;height:39px;border:1px solid rgba(246,184,75,.34);border-radius:50%;background:rgba(246,184,75,.12);color:#F6C66F;font:800 11px ui-monospace}.new-funnel-stage-main>div{min-width:0}.new-funnel-stage-main small{display:block;color:#B88943;font:700 8px ui-monospace;text-transform:uppercase;letter-spacing:.12em}.new-funnel-stage h3{margin:4px 0 3px;font-size:15px;line-height:1.2;letter-spacing:-.015em}.new-funnel-stage-main p{margin:0;color:#747D91;font-size:9px;line-height:1.35}.new-funnel-value{align-self:stretch;display:grid;place-content:center;text-align:center;border-left:1px solid rgba(255,255,255,.07);border-right:1px solid rgba(255,255,255,.07)}.new-funnel-value strong{font-size:30px;line-height:1;letter-spacing:-.045em}.new-funnel-value span{margin-top:4px;color:#737C90;font:700 7px ui-monospace;text-transform:uppercase;letter-spacing:.06em}.new-funnel-source{min-width:0;display:grid;gap:6px}.new-funnel-source span{color:#B4BBC9;font:700 9px ui-monospace}.new-funnel-source code{display:block;max-width:100%;overflow:hidden;text-overflow:ellipsis;color:#777F92;font:600 8px ui-monospace;white-space:nowrap}.new-funnel-stage.unavailable{border-style:dashed;background:linear-gradient(90deg,rgba(246,184,75,.07),rgba(10,13,21,.92))}.new-funnel-stage.unavailable .new-funnel-value strong{color:#697185}.new-funnel-stage.unavailable .new-funnel-source span{color:#777F92}.new-brand-foot{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:16px 24px;border-top:1px solid rgba(255,255,255,.07);color:#737C90;font-size:10px}.new-brand-foot span{display:flex;align-items:center;gap:7px}.new-brand-foot i{width:6px;height:6px;border-radius:50%;background:#F6B84B}.new-brand-foot p{margin:0;text-align:right}
