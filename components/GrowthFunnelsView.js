      ...
      <div className="new-brand-funnel-body" aria-label="Etapas do novo funil de Marcas">
        {visibleStages.map((stage, index) => {
          ...
          return <div className="new-funnel-unit" key={stage.key}>
            ...
            <article
              className={`new-funnel-stage ${unavailable ? "unavailable" : ""} ${stage.metricScope === "shared" ? "shared" : ""}`}
              data-metric-scope={stage.metricScope || "consolidated"}
            ...
            >
              ...
              <div className="new-funnel-big-number">
                <strong>{fmt(stage.value)}</strong>
                <span>{unavailable ? "aguardando fonte" : stage.metricScope === "shared" ? "total compartilhado" : "registros no período"}</span>
              </div>
