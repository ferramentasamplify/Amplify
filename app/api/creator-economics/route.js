...
async function readDailyAffiliation(from, to) {
  ...
  const series = rows.map((row) => ({
    ...
    gmvCreatorsLast30Days: Number(row.positive_gmv_creators_last_30_days) || 0,
