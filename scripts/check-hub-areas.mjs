...
if (!detail.includes("Biblioteca compartilhada") || !detail.includes("amplify-hub-area-library:v1") || !detail.includes("Adicionar de outras areas")) throw new Error("selecao cruzada de links ausente");
