export const NEW_BRAND_FUNNEL_STAGES = Object.freeze([
  ...
  { key: 'purchase-intent', eventName: 'Clicou em comprar', label: 'Intenção de compra', signal: 'Registro marcado como Clicou em comprar no Funil Mentoria', sourceLabel: 'Notion · Funil Mentoria' },
